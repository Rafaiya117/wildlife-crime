    ...
    <div class="row">
        <div class="col-md-12">
            <div class="innerPage-box">
                ...
                <form id="commentForm" class="inputs-p10 " method="post" action="./input-disposal-information.php" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="input_fields_wrap">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control inner-textfield" id="" required name="" value="">
                            </div>
                            <div class="form-group col-md-12">
                                <label class="inner-label required" id="witness-age">
                                    ...
                                    <input type="checkbox" name="approx_0" id="approx_0" class="" value="approc">
                                    approximately
                                </label>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control inner-textfield" id="officer_team" required name="officer_team" value="">
                            </div>
                        </div>
                    </div>
                <div>

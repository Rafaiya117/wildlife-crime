            ...
            <div class="innerPage-box">
                ...
                <table class="table table-bordered">
                    <form action="" id="commentForm" class="inputs-p10 " method="post">
                        ...
                        <tbody>
                            <tr>
                                <td onclick="location.href='./case-details.php'">001111</td>
                                <td onclick="location.href='./case-details.php'">Trade</td>
                                <td>52/1A</td>
                                <td onclick="location.href='./offender-details.php'">Sharma</td>
                                <!-- <td><a href="./details.php"  class="btn btn-primary">Details</a></td> -->
                            </tr>
                            <tr>
                                <td onclick="location.href='./offender-details.php'">001112</td>
                                <td onclick="location.href='./case-details.php'">Procession</td>
                                <td>41/3B,51/1AS</td>
                                <td onclick="location.href='./offender-details.php'">Singh</td>
                                <!-- <td><a href="./details.php"  class="btn btn-primary">Details</a></td> -->
                            </tr>
                        </tbody>
                    </form>

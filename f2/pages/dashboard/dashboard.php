...
<section class="content-header" id="dash_head">
  ...
  <div class="p-4"><a href="#modal2"  class="btn-dark btn-lg">Get Started(শুরু করুন) </a></div>
     ...
     <!-- Small boxes (Stat box) -->
      ...
      <?php echo trans("sm-1", 'bn');?></h4>
            ...
            <a href="#wildlife_law" class="small-box-footer">
              More(আরও) <i class="fa fa-chevron-circle-right" aria-hidden="true"></i>
            </a>
          </div>
        </div>  
      ...
      <?php echo trans("sm-2", 'bn');?></h4>
            ...
            <a href="#species" class="small-box-footer text-right">
              More(আরও) <i class="fa fa-chevron-circle-right" aria-hidden="true"></i>
            </a>
          </div>
        </div>
      ...
      <?php echo trans("sm-3", 'bn');?> </h4>
            ...
            <a href="#document" class="small-box-footer">
              More(আরও) <i class="fa fa-chevron-circle-right" aria-hidden="true"></i>
            </a>
          </div>
        </div>
      ...
      <?php echo trans("sm-4", 'bn');?></h4>
            ...
            <a href="#tradefor" class="small-box-footer">
              More(আরও) <i class="fa fa-chevron-circle-right" aria-hidden="true"></i>
            </a>
          </div>
        </div>
